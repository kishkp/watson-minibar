...
casper.test.begin('Watson Minibar Analyzer', 2, function suite(test) {
  ...
  casper.start(baseHost, function () {
    ...
    test.assertTitle('Watson Minibar Analyzer-Server', 'Title is correct');
  });

  casper.open(baseHost, {
    data: {
      method: 'POST',
      data: '../../server/data/20181217_124923.jpg'
    }
  });
